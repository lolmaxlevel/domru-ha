...
3. Выберите способ входа:
   - **Телефон + SMS-код** - введите номер телефона, выберите лицевой счёт, затем подтвердите код из SMS
   - **Логин + пароль** - используйте email/номер телефона и пароль от личного кабинета Dom.ru
4. Если выбран вход по логину и паролю, введите ваши учётные данные:
   - **Логин** - ваш email или номер телефона
   - **Пароль** - пароль от личного кабинета Dom.ru
5. Нажмите "Отправить"
6. Интеграция автоматически обнаружит все доступные устройства и создаст соответствующие сущности
